...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE flow_statistics
    ...
    USE arrays_3d,                                                                                 &
        ONLY:  ddzu, ddzw, d_exner,                                                                &
               e, exner, heatflux_output_conversion, hyp, km, kh,                                  &
               momentumflux_output_conversion,                                                     &
               nc, ni, ng, nr, ns, p, prho, prr, pt, q, qc, qi, qg, ql, qr, qs,                    &
               rho_air, rho_air_zw, rho_ocean, s, sa,                                              &
    ...
    USE land_surface_model_mod,                                                                    &
        ONLY:   m_soil, nzb_soil, nzt_soil, t_soil
