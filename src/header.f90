...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE header
    ...
    USE indices,                                                                                   &
        ONLY:  mg_loc_ind, nnx, nny, nnz, nx, nxl_mg, nxr_mg, ny, nyn_mg, nys_mg, nzt, nzt_mg,     &
               topo_top_ind
    ...
    USE pmc_interface,                                                                             &
        ONLY:  atmosphere_ocean_coupled_run, nested_run, nesting_bounds,                           &
               nesting_datatransfer_mode, nesting_mode
...
!-- Determine kind of model run
    ...
    ELSEIF ( INDEX( initializing_actions, 'inifor' ) /= 0  .OR.                                    &
