...
#if defined( __parallel )
    INTERFACE transpose_yxd
       MODULE PROCEDURE transpose_yxd
    END INTERFACE transpose_yxd
#endif
...
!--          non_uniform_subdomain, and lateral Neumann boundary conditions.
