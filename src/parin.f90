...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE parin
    ...
    USE arrays_3d,                                                                                 &
        ONLY:  pt_init, q_init, ref_state, s_init, sa_init, ug, u_init, v_init, vg
    ...
    USE pmc_interface,                                                                             &
        ONLY:  nested_run, nesting_bounds
...
!-- used in init_pegrid and init_grid and therefore cannot be check in check_parameters
